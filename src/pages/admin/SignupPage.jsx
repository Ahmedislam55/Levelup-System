...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage("User created successfully 🎉 Redirecting to users page...");
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="p-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 transition duration-200 hover:border-gray-400 appearance-none"
                  >
            ...
            <div className="mt-8 text-center pt-6 border-t border-gray-200">
              <Link
                to="/users"
                className="inline-flex items-center text-sm text-blue-600 hover:text-blue-500 transition duration-300 hover:underline font-medium"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
