...
export default function TeachersPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setModalMessage("Teacher created successfully 🎉");
  ...
  const handleToggleTeacherStatus = async (teacherId, currentStatus) => {
    try {
      ...
      const response = await api.patch(`/admin/teacher/${teacherId}`, payload);
      console.log(`Teacher ${newStatus ? "activated" : "deactivated"} successfully:`, response.data);
      ...
      setModalMessage("Failed to update teacher status ❌");
      setTimeout(() => {
        setModalMessage("");
      }, 3000);
    } finally {
  ...
  const handleDeleteTeacher = async (teacherId) => {
    try {
      ...
      const response = await api.patch(`/auth/${teacherId}/delete-profile`, {
        userId: teacherId,
      });
      ...
      setAllUsers((prevUsers) =>
        prevUsers.filter((user) => (user.id || user._id) !== teacherId)
      );
  ...
  const fetchUsers = async () => {
    try {
      ...
      try {
        ...
        console.log("✅ Teachers loaded:", result.data?.length, "teachers");
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-600 max-w-2xl">
                Manage all teachers in the system with comprehensive controls and search functionality
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3 text-sm text-gray-600">
              ...
              <span>{filteredUsers.length} teachers found</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div className="flex flex-col sm:flex-row items-center justify-between">
              <h2 className="text-white font-semibold text-lg mb-2 sm:mb-0">Teachers List</h2>
              <div className="flex items-center gap-2 text-blue-100 text-sm">
                <span>Page {page} of {totalPages}</span>
                <span className="text-blue-200">•</span>
                <span>Showing {currentPageUsers.length} teachers</span>
              </div>
            </div>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() => handleDeleteTeacher(u.id || u._id)}
                            disabled={loading}
            ...
            <div className="bg-gray-50 px-6 py-4 border-t">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-sm text-gray-600">
                  ...
                  <span className="font-semibold">{total}</span> teachers
                </div>
                <div className="flex items-center space-x-2">
                  <button
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 rounded-t-xl">
              <div className="flex items-center justify-between">
                <h2 className="text-white font-semibold text-lg">Add New Teacher</h2>
                <button
      ...
      {showUpdateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 rounded-t-xl">
              <div className="flex items-center justify-between">
                <h2 className="text-white font-semibold text-lg">Update Teacher</h2>
                <button
